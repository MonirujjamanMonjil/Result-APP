...
public class Dibs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dibs_web = findViewById(R.id.Dibs_web);
        Dibs_web.getSettings().setJavaScriptEnabled(true);
        Dibs_web.setWebViewClient(new WebViewClient());

        Dibs_web.loadUrl("https://eboardresults.com/v2/home");




        if(!isNetworkAvailable(Dibs.this)){
