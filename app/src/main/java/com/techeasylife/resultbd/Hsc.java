...
public class Hsc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Hsc_web = findViewById(R.id.Hsc_web);
        Hsc_web.getSettings().setJavaScriptEnabled(true);
        Hsc_web.loadUrl("https://eboardresults.com/v2/home");



        if(!isNetworkAvailable(Hsc.this)){
